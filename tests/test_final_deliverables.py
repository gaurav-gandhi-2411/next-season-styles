...
# the M-session final three (dress) were generated by `m3_generate`, so that table has no dress
# row. The shipped figures are built by `h4_deliverables.main()` (covered by the H4 tests).
